      ...
      <div className={styles.topHeader}>
        <div className={styles.headerContent}>
          <div className={styles.headerLeft}>
            ...
            <span className={styles.subtitle}>Powered by Prospero Solutions</span>
          </div>
          <div className={styles.headerRight}>
            ...
            <div className={styles.userProfile}>
              ...
              <svg className={styles.dropdownIcon} width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <nav className={styles.navigation}>
          {navigationItems.map((item) => (
            <div key={item.id} className={styles.navItemWrapper}>
              <Link
                href={item.href}
                className={`${styles.navItem} ${isActiveRoute(item.href) ? styles.active : ''}`}
              >
